...
Although there is some inconsistency over the exact definition of evolvability, most thinking is consistent with the notion that evolvability stems from traits that facilitate the generation of \textit{novel} heritable phenotypic variation that is \textit{viable} \cite{tarapore2015evolvability}.
